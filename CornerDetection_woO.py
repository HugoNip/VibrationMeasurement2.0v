...
while(cap.isOpened()):
    ...
    if ret == True:
        ...
        copy_imCrop[res_show[:,1], res_show[:,0]] = [0, 0, 255]
        copy_imCrop[res_show[:,3], res_show[:,2]] = [0, 255, 0]
...
np.savetxt('data_O_S_58_CornerDetection.csv', ydisp_global_plot, delimiter=',')
...
plt.savefig('S_vDisp_58_Corner.png')
plt.show()
